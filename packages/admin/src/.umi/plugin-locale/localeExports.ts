...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'D:/My-project/cloudbase-cms/packages/admin/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'D:/My-project/cloudbase-cms/packages/admin/node_modules/warning/warning.js';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/My-project/cloudbase-cms/packages/admin/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/My-project/cloudbase-cms/packages/admin/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
